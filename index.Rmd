...
Pacotes necessários para as funções utilizadas
```{r}
...
Aqui podemos ver que a área de ocorrência da especie é predominantemente na Ámerica do Sul
```{r}
# habitat
xylopea_gbif1 %>%
    group_by(habitat) %>% 
...
Podemos aqui gerar um mapa mundo confirmando que a área de distribuição da Xylopia sericea é prodominante da América do Sul, com alguns pontos de ocorrencia na América Central e um ponto na África.
```{r}
